...
//    @StateObject private var viewModel = NearestBusViewModel()
...
//                    viewModel.stop()
//                } else {
//                    // 임시로 routeId와 destinationStationId 설정
//                    viewModel.configure(routeId: "100100414", destinationStationId: "5678")
//                    viewModel.start()
//                }
//                isRunning.toggle()
//            }) {

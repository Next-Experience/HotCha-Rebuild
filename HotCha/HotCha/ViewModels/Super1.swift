...
//import Combine
//
//class NearestBusViewModel1: ObservableObject {
...
//    ) -> BusStation? {
//        
//        // 1. 거리순으로 가장 가까운 두 정류장 찾기
//        let sortedByDistance = stations.sorted {
...
//        
//        // 2. 목적지와의 seq 차이가 작은 쪽 선택
//        let selected = closestTwo.min(by: {
...
//        stations: busStops,
//        lastSeq: Int? // 마지막으로 감지된 정류장의 순번
//    ) -> (stationId: String, arrived: Int)? {
//        
//        // 기준 반경
//        let detectionRadius: Double = 200.0
//        
//        // 정렬된 정류장 목록
//        let sortedStations = stations.sorted { $0.seq < $1.seq }
//        
//        // 다음 확인할 시작 순번
//        let startSeq = (lastSeq ?? 0) + 1
//        
//        // 다음 순번부터 탐색
//        for station in sortedStations where station.seq >= startSeq {
//            let stationLocation = CLLocation(latitude: station.gpsY, longitude: station.gpsX)
//            let distance = currentLocation.distance(from: stationLocation)
//            
//            if distance == detectionRadius {
//                return (station.station, 0) // 도착
//            } else {
//                return (station.station, 1) // 아직 도착 안함
//            }
//        }
//        
//        return nil // 더 이상 남은 정류장 없음
//    }
//
//    
//}
...
//
//    @State private var stationInput = "118000261"
